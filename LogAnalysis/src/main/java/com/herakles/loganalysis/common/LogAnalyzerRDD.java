package com.herakles.loganalysis.common;
...
public class LogAnalyzerRDD {
  ...
  public OldLogStatistics processRdd(JavaRDD<ApacheAccessLog> accessLogs) {
    ...
    OldLogStatistics stats = new OldLogStatistics();
